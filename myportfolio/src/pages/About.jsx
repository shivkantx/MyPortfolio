      ...
      <div className="flex flex-col items-center p-4  justify-between">
        ...
        <div className="flex flex-col md:flex-row mt-10 gap-10 w-full items-center justify-center px-4">
          <div className="order-2 md:order-1 w-full md:w-1/2 flex flex-col items-center md:items-start justify-center text-center md:text-left text-white space-y-4">
            ...
            <p data-aos="fade-left" className="text-justify text-lg font-extralight">
            ...
            <div data-aos="fade-left" className="mt-6 flex flex-col sm:flex-row gap-4">
              <Link
      ...
      <div className="mt-[50px] flex flex-wrap gap-x-5 gap-y-5">
        ...
        >
          <div className="flex justify-between">
            ...
            <h1 data-aos="fade-left" className="text-4xl font-extrabold">4</h1>
          </div>
          <div className="flex justify-between">
            <div>
              <h1 data-aos="fade-up" className="text-md font-semibold">TOTAL PROJECTS</h1>
              <p data-aos="fade-up" className="text-xs">Innovative web solutions crafted</p>
            </div>
        ...
        >
          <div className="flex justify-between group">
            ...
            <h1 data-aos="fade-left" className="text-4xl font-extrabold">2</h1>
          </div>
          <div className="flex justify-between">
            <div>
              <h1 data-aos="fade-up" className="font-semibold">CERTIFICATES</h1>
              <p data-aos="fade-up" className="text-xs">Professional skills validated</p>
            </div>
            <div className="flex items-end justify-end">
        ...
        >
          <div className="flex justify-between">
            ...
            <h1 data-aos="fade-left" className="text-4xl font-extrabold">3</h1>
          </div>
          <div className="flex justify-between">
            <div>
              <h1 data-aos="fade-up" className="font-semibold">YEARS OF EXPERIENCE</h1>
              <p data-aos="fade-up" className="text-xs">Continuous learning journey</p>
            </div>
            <div className="flex items-end justify-end">
              <svg fill="white" xmlns="http://www.w3.org/2000/svg" width="20" height="20">
                <path d="M7 7h8.586L5.293 17.293l1.414 1.414L17 8.414V17h2V5H7v2z" />
